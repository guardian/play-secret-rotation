...
lazy val crossCompileScala3 = crossScalaVersions := Seq(scalaVersion.value, "3.4.0")
...
val awsSdkForVersion = Map(
  1 -> "com.amazonaws" % "aws-java-sdk-ssm" % "1.12.647",
  2 -> "software.amazon.awssdk" % "ssm" % "2.23.13"
)
